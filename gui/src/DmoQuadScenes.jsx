...
// - currentPage
// - onClickLift
export class DmoQuadScenesMenu extends React.Component {
    render() {
        let color = "";
        ...
        return (
            <div onClick={this.props.onClickLift}>
                <Title tag='h1' hasTextColor={color}>QuadScenes</Title>
            </div>
        );
    }
}
...
// - dmoData
// - onChangeLift
export class QuadScenesPage extends React.Component {
    constructor(props) {
        super(props);
