...
fn mul_matrix4_by_vector4() {
    ...
    let m: Matrix4 = Matrix4::from_row_slice([
        [2.5, 3.4, 1.1, 5.2],
        [0.0, 1.0, 8.4, 8.9],
        [2.1, 6.7, 1.0, 4.4],
        [5.1, 0.0, 7.5, 2.1],
...
fn mul_matrix4_by_matrix4() {
    let a: Matrix4 = Matrix4::from_row_slice([
        [2.5, 3.4, 1.1, 5.2],
        [0.0, 1.0, 8.4, 8.9],
        [2.1, 6.7, 1.0, 4.4],
        [5.1, 0.0, 7.5, 2.1],
    ...
    let b: Matrix4 = Matrix4::from_row_slice([
        [3.8, 5.1, 7.2, 8.0],
        [4.2, 4.6, 2.6, 8.2],
        [6.3, 7.1, 8.5, 5.5],
        [5.4, 1.1, 0.0, 6.3],
    ...
    // column major
    let expect = [
        [58.79, 105.17999, 66.17999, 77.97],
...
fn look_at_lh_no_translate() {
    ...
    // column major
    let expect = [
        [0.8944272, -0.2981424, 0.33333334, 0.0],
...
fn look_at_lh() {
    ...
    // column major
    let expect = [
        [-0.83205026, 0.5149166, 0.20628424, 0.0],
...
fn perspective_matrix() {
    let res = Matrix4::new_perspective(1024.0 / 768.0, 45.0_f32.to_radians(), 0.1, 100.0);
    // column major
    let expect = [
        [1.81066, 0.0, 0.0, 0.0],
...
#[test]
fn rotation_euler() {
    let res = Matrix4::new_rotation_euler(to_radians(12.0), to_radians(-25.2), to_radians(55.9));

    let expect = [
        [0.5072813, 0.7492514, 0.42577928, 0.0],
